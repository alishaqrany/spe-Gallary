...
import ImageGridhlifeBet from '../components/image-grade/ImageGrid-hlifeBet';
import Modal from '../components/Modal';
import Footer from '../components/footer';
import {Nav, NavDropdown} from 'react-bootstrap';


function HlifeBet(props) {
  ...
  return (
        (<>
          ...
          <div className='container'>
              <h1>
                  حياة كريمة اثناء التنفيذ
               </h1>
            </div>

            <ImageGridhlifeBet setSelectedImg={setSelectedImg} />
