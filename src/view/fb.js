...
import ImageGridfb from '../components/image-grade/ImageGrid-fb';
import Modal from '../components/Modal';
import Footer from '../components/footer';
import {Nav, NavDropdown} from 'react-bootstrap';

function Flashback(props) {
  ...
  return (
        (<>
          ...
          <Nav variant="pills" defaultActiveKey="link-4">
            <Nav.Item>
            ...
            <ImageGridfb setSelectedImg={setSelectedImg} />
