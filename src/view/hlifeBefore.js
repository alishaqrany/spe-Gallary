...
import ImageGridhlifeBefore from '../components/image-grade/ImageGrid-hlifeBefore';
import Modal from '../components/Modal';
import Footer from '../components/footer';
import {Nav, NavDropdown} from 'react-bootstrap';


function HlifeBefore(props) {
  ...
  return (
        (<>
          ...
          <div className='container'>
              <h1>
                  حياة كريمة قبل التنفيذ
               </h1>
            </div>

            <ImageGridhlifeBefore setSelectedImg={setSelectedImg} />
